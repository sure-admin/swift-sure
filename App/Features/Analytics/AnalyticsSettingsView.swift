  ...
  var body: some View {
    Form {
      Section {
        ...
        Text("Help improve Sure by sharing screen views, welcome choices, and Wallet sync results and error categories with PostHog, along with app and device information. Financial data, server addresses, credentials, and conversations are excluded. No session recordings are collected. You can turn this off at any time.")
      }
